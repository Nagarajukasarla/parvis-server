...
import com.parvis.repository.AdminRepository;
...
public class AdminServiceImplementation implements AdminService {
    ...
    private static final Logger logger = Logger.getLogger(AdminServiceImplementation.class.getName());
    ...
    public AppResponse<EmployeeCreateResponse> createEmployee(EmployeeCreateRequest request) {
        ...
        try {
            ...
            return adminRepository.createEmployee(request);
        }
    ...
    public AppResponse<String> deleteEmployee(String id) {
        try {
            validateRequired(Optional.of(id), "EmployeeId", "EMPLOYEE ID MISSING");
            return adminRepository.deleteEmployee(id);
        }
        catch (DatabaseException exception) {
            return AppResponse.failure(
                    ErrorDetails.db(
